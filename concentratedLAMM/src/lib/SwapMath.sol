...
// specify the maximum amount of token that will go in for this trade: exactIn. In this case,
// amountRemaining will be a positive number

// if we are specifying the amount of token out, then the amount remaining will be a negative number

// -------

// feePip is the percentage from amountIn that we are going to be charging for the swap
